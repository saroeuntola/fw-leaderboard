...
<?php 
$jsNavbar = file_get_contents($_SERVER ['DOCUMENT_ROOT'] . '/V2/js/navbar.js');
$encodedNavbar = base64_encode($jsNavbar);
echo '<script src="data:text/javascript;base64,' . $encodedNavbar . '" defer></script>';
?>
