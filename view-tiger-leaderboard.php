...
<head>
    ...
    <title>Tiger Leaderboard Fancbet</title>
    <meta name="description" content="View the latest Fancybet tiger leaderboard in Bangladesh. Check player rankings, scores, and real-time updates." />
    ...
    <link rel="canonical" href="https://fancybet-leaderboard.com/view-tiger-leaderboard" />
    ...
    <meta property="og:url" content="https://fancybet-leaderboard.com/view-tiger-leaderboard" />
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://fancybet-leaderboard.com/view-tiger-leaderboard",
...
<body class=" dark:bg-[#181818] bg-[#f5f5f5] dark:dark:text-white text-gray-900 min-h-screen">
    ...
    <main class="pt-[90px] m-auto max-w-7xl px-4 pb-10">
        ...
        <div id="container-tiger"
            ...
            <?php
            include "./tiger-leaderboard-section.php";
            ?>
        </div>
    </main>
    <?php
