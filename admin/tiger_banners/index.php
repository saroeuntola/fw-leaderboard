...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['update'])) {
        ...
        $bannerObj->updatetiger_banners($id, $title, $image, $link);
    }
...
<body class="flex h-screen bg-gray-900 ">
    ...
    <main class="flex-1 ml-64 p-6 transition-all duration-300 text-white" id="main-content">
        <div class="flex justify-between mb-4">
            <h1 class="text-2xl font-bold">Tiger Banner Management</h1>
            <button class="btn border-none bg-green-600 text-white" onclick="document.getElementById('createModal').showModal()">+ Add Banner</button>
        </div>
    ...
    <dialog id="editModal" class="modal">
        <div class="modal-box">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <input type="text" name="link" id="editLink" class="input input-bordered w-full mb-2" />
